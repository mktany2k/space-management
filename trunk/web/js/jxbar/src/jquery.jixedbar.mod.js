		...
		jixedbar: new function(options) {
			...
			this.construct = function() {
				...
				return this.each(function() {
					...
					$("#jx-hid-con-id").html('<li alt="Hide"><a id="jx-hid-btn-id" class="' + hideIndicator + '"></a></li>');
					...
					// add the show/unhide item ("Show" button)
					$("#jx-uhid-itm-id").html('<li alt="Show"><a id="jx-uhid-btn-id" class="' + unhideIndicator + '"></a></li>');
					...
					$("li", obj).each(function() { // iterate through LI element
						// allanc@17052011 - added to be compatible with jquery-1.6.1
						$(this).html($(this).html().replace(/(&nbsp;)(undefined)/g, ''));
					...
					$("li", obj).find("ul").each(function() {
						...
						/* allanc@17052011 - removed up/down arrow
