...
<html>
    <head>
        ...
        <link rel="shortcut icon" href="<s:url value="/images/svg.ico"/>"/>
        <!--
        -->
        <link rel="stylesheet" href="<s:url value="/css/default.css"/>" type="text/css"/>
        <link rel="stylesheet" href="<s:url value="/js/SlickGrid-1.4.3-62/slick.grid.css"/>" type="text/css" media="screen"/>
        <link rel="stylesheet" href="<s:url value="/js/SlickGrid-1.4.3-62/css/smoothness/jquery-ui-1.8.5.custom.css"/>" type="text/css" media="screen"/>
        <link rel="stylesheet" href="<s:url value="/js/SlickGrid-1.4.3-62/examples/examples.css"/>" type="text/css" media="screen"/>
        <script type="text/javascript" src="<s:url value="/js/fn-maintenance.js"/>"></script>
        <!--
        ...
        <!-- SlickGrid starts -->
        <script src="<s:url value="/js/SlickGrid-1.4.3-62/lib/firebugx.js"/>"></script>
        <script src="<s:url value="/js/SlickGrid-1.4.3-62/lib/jquery-1.4.3.min.js"/>"></script>
        <script src="<s:url value="/js/SlickGrid-1.4.3-62/lib/jquery-ui-1.8.5.custom.min.js"/>"></script>
        <script src="<s:url value="/js/SlickGrid-1.4.3-62/lib/jquery.event.drag-2.0.min.js"/>"></script>
        <script src="<s:url value="/js/SlickGrid-1.4.3-62/plugins/slick.cellrangeselector.js"/>"></script>
        <script src="<s:url value="/js/SlickGrid-1.4.3-62/plugins/slick.cellselectionmodel.js"/>"></script>
        <script src="<s:url value="/js/SlickGrid-1.4.3-62/slick.core.js"/>"></script>
        <script src="<s:url value="/js/SlickGrid-1.4.3-62/slick.editors.js"/>"></script>
        <script src="<s:url value="/js/SlickGrid-1.4.3-62/slick.grid.js"/>"></script>
        <!-- SlickGrid ends -->
