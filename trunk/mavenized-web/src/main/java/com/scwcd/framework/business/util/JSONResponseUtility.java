...
public class JSONResponseUtility {
	...
	public static String buildState(final HttpServletRequest request, final String username) {
		final ApplicationSession appSession = (ApplicationSession) request.getSession().getAttribute(ApplicationSession.SESSION_APPLICATION);
		...
		state.append(", \"d\": ").append("false"); // true if view/lot has been modified
		state.append(" } ");
